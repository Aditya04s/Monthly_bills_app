...
export function AppShell({ activeRoute, children, onNavigate }: AppShellProps) {
  ...
  return (
    <div className="min-h-svh bg-app-bg text-app-text">
      <OfflineBanner />
      <header className="safe-top sticky top-0 z-10 border-b border-app-border/70 bg-app-bg/95 px-4 pb-3 backdrop-blur">
        <div className="mx-auto flex max-w-md items-center justify-between">
          ...
          <div
            className="flex h-10 w-10 items-center justify-center rounded-full bg-app-accentSoft text-sm font-bold text-app-accent"
            aria-hidden="true"
          >
            BA
          </div>
